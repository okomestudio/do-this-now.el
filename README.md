...
up and do some stretch every hour or so. Or may be make a cup of coffee.
...
(use-package do-this-now
  ...
  :custom ((alert-default-style 'notifications)
           (do-this-now-idle-interval 600)             ; restart timer after 10 min of inactivity
           (do-this-now-interval 2400)                 ; notify in 40 min of activity
...
- [ ] Add fixed alert interval mode? Current assumption is to trigger alert after an
      extended period of activity with Emacs, in order to get some exercise in. In some
      cases, one might pefer to have alerts trigger at a fixed interval, regardless of
      activity level.
